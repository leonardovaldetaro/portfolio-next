    ...
    return (
        <article className={Styles.aboutSection}>
            <figure className={Styles.aboutSection__figure}>
                <Image
                    src="/assets/leonardoValdetaro.webp"
            ...
            <div className={Styles.aboutSection__content}>
                ...
                <p className={Styles.aboutSection__content__description}>I&rsquo;m a skilled front-end web developer and experienced digital designer. I specialize in creating responsive websites and functional user interfaces that meet the needs of my clients and their target audience.</p>
